...
url = "https://53e3ddc35f2c452a997f784fa0e58b84.us-central1.gcp.cloud.es.io/api/detection_engine/rules"
...
data = ""
for root, dirs, files in os.walk("C:/Users/HassnainMoavia/OneDrive - ARANCIA/Desktop/GITHUB/detection-rules/converted_detections"):
    for file in files:
        data = "{\n"
